...
'@; $content | Set-Content -Path 'src\App.jsx' -Encoding UTF8 -NoNewline; Write-Host ('Lines: ' + ($content -split \"\n\").Count)"
git add -f src\App.jsx
git commit -m "fix: complete App.jsx with all components"
